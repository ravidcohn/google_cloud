...
public class QuoteApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetQuote extends QuoteApiRequest<com.example.ravid.myapplication.backend.quoteApi.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(QuoteApi.this, "GET", REST_PATH, null, com.example.ravid.myapplication.backend.quoteApi.model.Quote.class);
   ...
   *
   * @param content the {@link com.example.ravid.myapplication.backend.quoteApi.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.example.ravid.myapplication.backend.quoteApi.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteApiRequest<com.example.ravid.myapplication.backend.quoteApi.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.example.ravid.myapplication.backend.quoteApi.model.Quote content) {
      super(QuoteApi.this, "POST", REST_PATH, content, com.example.ravid.myapplication.backend.quoteApi.model.Quote.class);
    }
