...
package com.example.ravid.myapplication.backend.quoteApi.model;

/**
 * Model definition for Quote.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the quoteApi. For a detailed explanation see:
...
public final class Quote extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.lang.String getWhom() {
    return whom;
  }

  /**
   * @param whom whom or {@code null} for none
   */
  public Quote setWhom(java.lang.String whom) {
    this.whom = whom;
    return this;
  }
